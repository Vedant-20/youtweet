...
function ChannelVideos() {
    ...
    try {
      setLoading(true)
      const response=await axios.get(`${import.meta.env.VITE_BACKEND_URL}/dashboard/channel-videos`,{withCredentials:true,headers:{
    ...
    const DeleteVideo=async(videoId)=>{
      try {
        setLoading(true)
        const response=await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/videos/delete-video/${videoId}`,{withCredentials:true})
